...
```
Looking at the results on the above graph, the data has a negative skewness and a kurtosis not far from 3, the fit of three common left-skewed distributions could be considered, Weibull, gamma and lognormal distributions.
