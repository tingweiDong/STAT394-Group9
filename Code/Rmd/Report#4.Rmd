...
```{r weibull, fig.cap="Fitting weibull distribution in G3 variable", echo=FALSE, warning=FALSE, message=FALSE, error=FALSE}
weibull_dist <- fitdist(df_num$G3, "norm", method = "mge")
plot(weibull_dist)
```

```{r gamma, fig.cap="Fitting gamma distribution in G3 variable", echo=FALSE, warning=FALSE, message=FALSE, error=FALSE}
gmma_dist <- fitdist(df_num$G3, "gamma", method = "mge")
plot(gmma_dist)
```
