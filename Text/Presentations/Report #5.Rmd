...
## Multivariate Normal Distribution by splitting data by Sex and Failures{.smaller .columns-2}
...
-   PCA. Exploring our dataset we found that the first, second and third period grades (G1, G2, G3) show strong positive correlation with each other. This is our initial motivation for a future PCA analysis to understand these relationships in the dataset further.
